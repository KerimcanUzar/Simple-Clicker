...
func _ready():
	...
	if upgrade2 == 4:
		...
		if multiplier >= 1000000/35:
			$cateringlabel.set_text(str(stepify(0.000035*multiplier,0.1)) + "B/sec - Cost: 9M")
		if multiplier >= 1000/35:
			$cateringlabel.set_text(str(stepify(0.035*multiplier,0.1)) + "M/sec - Cost: 9M")
		elif multiplier < 1000/35:
			$cateringlabel.set_text(str(stepify(35*multiplier,0.1)) + "K/sec - Cost: 9M")
		$buttons/catering.set_disabled(true)
	if upgrade2 == 5:
	...
	if upgrade4 == 2:
		...
		if multiplier >= 1000/300:
			$sportslabel.set_text(str(stepify(0.003*multiplier,0.1)) + "K/sec - Cost: 350K")
		elif multiplier < 1000/300:
			$sportslabel.set_text(str(stepify(300*multiplier,0.1)) + "/sec - Cost: 350K")
		$buttons/sports.set_disabled(true)
	if upgrade4 == 3:
	...
	if upgrade9 == 2:
		...
		if multiplier >= 10000/7:
			...
			$businesslabel.set_text(str(stepify(0.7*multiplier,0.1)) + "K/sec - Cost: 4070MM")
		elif multiplier < 1000/700:
	...
	if upgrade11 == 4:
		...
		$button/military.set_disabled(true)
	if upgrade11 == 5:
...
func _on_music_pressed():
	if upgrade == 0:
		if count >= 100:
			...
			counter += 1
			$buttons/music.set_text("Hummer")
			$musiclabel.set_text("50/sec - Cost: 10K")
			$buttons/music.set_disabled(true)
	if upgrade == 1:
		if count >= 10000:
			count -= 10000
			counter += 50
			$buttons/music.set_text("Whistler")
			$musiclabel.set_text("1K/sec - Cost: 500K")
			$buttons/music.set_disabled(true)
	if upgrade == 2:
		if count >= 500*K:
			count -= 500*K
			counter += 1000
			$buttons/music.set_text("Singer")
			$musiclabel.set_text("2.5K/sec - Cost: 2.5B")
			$buttons/music.set_disabled(true)
	if upgrade == 3:
		if count >= 2500*M:
			count -= 2500*M
			counter += 2500
			$buttons/music.set_text("Musician")
			$musiclabel.set_text("5K/sec - Cost: 10B")
			$buttons/music.set_disabled(true)
	if upgrade == 4:
		if count >= 10*B:
			count -= 10*B
...
func _on_catering_pressed():
	if upgrade2 == 0:
		if count >= 400:
			...
			counter += 2
			$buttons/catering.set_text("Egg Breaker")
			$cateringlabel.set_text(str(15*multiplier) + "/sec - Cost: 6K")
			$buttons/catering.set_disabled(true)
	if upgrade2 == 1:
		if count >= 6000:
			count -= 6000
			counter += 15
			$buttons/catering.set_text("Caterer")
			$cateringlabel.set_text("30/sec - Cost: 22.5K")
			$buttons/catering.set_disabled(true)
	if upgrade2 == 2:
		if count >= 22500:
			count -= 22500
			counter += 30
			$buttons/catering.set_text("Cook")
			$cateringlabel.set_text("200/sec - Cost: 300K")
			$buttons/catering.set_disabled(true)
	if upgrade2 == 3:
		if count >= 300*K:
			count -= 300*K
			counter += 200
			$buttons/catering.set_text("Chef")
			$cateringlabel.set_text("3K/sec - Cost: 9M")
			$buttons/catering.set_disabled(true)
	if upgrade2 == 4:
		if count >= 9*M:
			count -= 9*M
...
func _on_computer_pressed():
	if upgrade3 == 0:
		if count >= 900:
			...
			counter += 3
			$buttons/computer.set_text("Dummy")
			$computerlabel.set_text("8/sec - Cost: 4.8K")
			$buttons/computer.set_disabled(true)
	if upgrade3 == 1:
		if count >= 4800:
			count -= 4800
			counter += 8
			$buttons/computer.set_text("User")
			$computerlabel.set_text("30/sec - Cost: 36K")
			$buttons/computer.set_disabled(true)
	if upgrade3 == 2:
		if count >= 36*K:
			count -= 36*K
			counter += 30
			$buttons/computer.set_text("Power User")
			$computerlabel.set_text("2K/sec - Cost: 5M")
			$buttons/computer.set_disabled(true)
	if upgrade3 == 3:
		if count >= 5*M:
			count -= 5*M
			counter += 2000
			$buttons/computer.set_text("Computer Wizard")
			$computerlabel.set_text("7.5K/sec - Cost: 37.5M")
			$buttons/computer.set_disabled(true)
	if upgrade3 == 4:
		if count >= 37.5*M:
			count -= 37.5*M
...
func _on_sports_pressed():
	if upgrade4 == 0:
		if count >= 3*K:
			...
			counter += 5
			$buttons/sports.set_text("Gymnast")
			$sportslabel.set_text("35/sec - Cost: 42K")
			$buttons/sports.set_disabled(true)
	if upgrade4 == 1:
		if count >= 42*K:
			count -= 42*K
			counter += 35
			$buttons/sports.set_text("Athlete")
			$sportslabel.set_text("300/sec - Cost: 350K")
			$buttons/sports.set_disabled(true)
	if upgrade4 == 2:
		if count >= 750*K:
			count -= 750*K
			counter += 300
			$buttons/sports.set_text("Footballer")
			$sportslabel.set_text("750/sec - Cost: 3.75M")
			$buttons/sports.set_disabled(true)
	if upgrade4 == 3:
		if count >= 3.75*M:
			count -= 3.75*M
			counter += 750
			$buttons/sports.set_text("Boxer")
			$sportslabel.set_text("4K/sec - Cost: 40M")
			$buttons/sports.set_disabled(true)
	if upgrade4 == 4:
		if count >= 40*M:
			count -= 40*M
...
func _on_science_pressed():
	if upgrade5 == 0:
		if count >= 8.4*K:
			...
			counter += 7
			$buttons/science.set_text("Nerd")
			$sciencelabel.set_text("100/sec - Cost: 250K")
			$buttons/science.set_disabled(true)
	if upgrade5 == 1:
		if count >= 250*K:
			count -= 250*K
			counter += 100
			$buttons/science.set_text("Inventor")
			$sciencelabel.set_text("400/sec - Cost: 2M")
			$buttons/science.set_disabled(true)
	if upgrade5 == 2:
		if count >= 2*M:
			count -= 2*M
			counter += 400
			$buttons/science.set_text("Theorist")
			$sciencelabel.set_text("2.5K/sec - Cost: 25M")
			$buttons/science.set_disabled(true)
	if upgrade5 == 3:
		if count >= 25*M:
			count -= 25*M
			counter += 2500
			$buttons/science.set_text("Mad Scientist")
			$sciencelabel.set_text("9K/sec - Cost: 180M")
			$buttons/science.set_disabled(true)
	if upgrade5 == 4:
		if count >= 180*M:
			count -= 180*M
...
func _on_health_pressed():
	if upgrade6 == 0:
		if count >= 25*K:
			...
			counter += 10
			$buttons/health.set_text("Intern")
			$healthlabel.set_text("60/sec - Cost: 300K")
			$buttons/health.set_disabled(true)
	if upgrade6 == 1:
		if count >= 300*K:
			count -= 300*K
			counter += 60
			$buttons/health.set_text("Assistant")
			$healthlabel.set_text("100/sec - Cost: 1M")
			$buttons/health.set_disabled(true)
	if upgrade6 == 2:
		if count >= 1*M:
			count -= 1*M
			counter += 100
			$buttons/health.set_text("Nurse")
			$healthlabel.set_text("250/sec - Cost: 5M")
			$buttons/health.set_disabled(true)
	if upgrade6 == 3:
		if count >= 5*M:
			count -= 5*M
			counter += 250
			$buttons/health.set_text("Practitioner")
			$healthlabel.set_text("1K/sec - Cost: 5M")
			$buttons/health.set_disabled(true)
	if upgrade6 == 4:
		if count >= 40*M:
			count -= 40*M
...
func _on_acting_pressed():
	if upgrade7 == 0:
		if count >= 90*K:
			...
			counter += 15
			$buttons/acting.set_text("Clown")
			$actinglabel.set_text("65/sec - Cost: 780K")
			$buttons/acting.set_disabled(true)
	if upgrade7 == 1:
		if count >= 780*K:
			count -= 780*K
			counter += 65
			$buttons/acting.set_text("Actor")
			$actinglabel.set_text("800/sec - Cost: 20M")
			$buttons/acting.set_disabled(true)
	if upgrade7 == 2:
		if count >= 20*M:
			count -= 20*M
			counter += 800
			$buttons/acting.set_text("Starring")
			$actinglabel.set_text("2.5K/sec - Cost: 20M")
			$buttons/acting.set_disabled(true)
	if upgrade7 == 3:
		if count >= 125*M:
			count -= 125*M
			counter += 2500
			$buttons/acting.set_text("Director")
			$actinglabel.set_text("7K/sec - Cost: 700M")
			$buttons/acting.set_disabled(true)
	if upgrade7 == 4:
		if count >= 700*M:
			count -= 700*M
...
func _on_killing_pressed():
	if upgrade8 == 0:
		if count >= 250*K:
			...
			counter += 20
			$buttons/killing.set_text("Amateur")
			$killinglabel.set_text("150/sec - Cost: 3.75M")
			$buttons/killing.set_disabled(true)
	if upgrade8 == 1:
		if count >= 3.75*M:
			count -= 3.75*M
	...
	if upgrade8 == 2:
		if count >= 20*M:
			...
			counter += 400
			$buttons/killing.set_text("Assassin")
			$killinglabel.set_text("700/sec - Cost: 70M")
			$buttons/killing.set_disabled(true)
	if upgrade8 == 3:
		if count >= 70*M:
			count -= 70*M
			counter += 700
			$buttons/killing.set_text("Ninja")
			$killinglabel.set_text("7K/sec - Cost: 1.4B")
			$buttons/killing.set_disabled(true)
	if upgrade8 == 4:
		if count >= 1.4*B:
			count -= 1.4*B
...
func _on_business_pressed():
	if upgrade9 == 0:
		if count >= 625*K:
			...
			counter += 25
			$buttons/business.set_text("Worker")
			$businesslabel.set_text("30/sec - Cost: 1.5M")
			$buttons/business.set_disabled(true)
	if upgrade9 == 1:
		if count >= 1.5*M:
			count -= 1.5*M
			counter += 30
			$buttons/business.set_text("Manager")
			$businesslabel.set_text("700/sec - Cost: 70M")
			$buttons/business.set_disabled(true)
	if upgrade9 == 2:
		if count >= 70*M:
			count -= 70*M
			counter += 700
			$buttons/business.set_text("Vice President")
			$businesslabel.set_text("3K/sec - Cost: 600M")
			$buttons/business.set_disabled(true)
	if upgrade9 == 3:
		if count >= 600*M:
			count -= 600*M
			counter += 3000
			$buttons/business.set_text("CEO")
			$businesslabel.set_text("8K/sec - Cost: 3.2B")
			$buttons/business.set_disabled(true)
	if upgrade9 == 4:
		if count >= 3.2*B:
			count -= 3.2*B
...
func _on_legal_pressed():
	if upgrade10 == 0:
		if count >= 1.5*M:
			...
			counter += 30
			$buttons/legal.set_text("Clerk")
			$legallabel.set_text("90/sec - Cost: 9M")
			$buttons/legal.set_disabled(true)
	if upgrade10 == 1:
		if count >= 9*M:
			count -= 9*M
			counter += 90
			$buttons/legal.set_text("Paralegal")
			$legallabel.set_text("200/sec - Cost: 40M")
			$buttons/legal.set_disabled(true)
	if upgrade10 == 2:
		if count >= 40*M:
			count -= 40*M
			counter += 200
			$buttons/legal.set_text("Attorney")
			$legallabel.set_text("400/sec - Cost: 160M")
			$buttons/legal.set_disabled(true)
	if upgrade10 == 3:
		if count >= 160*M:
			count -= 160*M
			counter += 400
			$buttons/legal.set_text("Prosecutor")
			$legallabel.set_text("900/sec - Cost: 720M")
			$buttons/legal.set_disabled(true)
	if upgrade10 == 4:
		if count >= 720*M:
			count -= 720*M
...
func _on_military_pressed():
	if upgrade11 == 0:
		if count >= 4*M:
			...
			counter += 40
			$buttons/military.set_text("Private")
			$militarylabel.set_text("80/sec - Cost: 16M")
			$buttons/military.set_disabled(true)
	if upgrade11 == 1:
		if count >= 16*M:
			count -= 16*M
			counter += 80
			$buttons/military.set_text("Sergeant")
			$militarylabel.set_text("400/sec - Cost: 160M")
			$buttons/military.set_disabled(true)
	if upgrade11 == 2:
		if count >= 160*M:
			count -= 160*M
			counter += 400
			$buttons/military.set_text("Lieutenant")
			$militarylabel.set_text("1.6K/sec - Cost: 1.2B")
			$buttons/military.set_disabled(true)
	if upgrade11 == 3:
		if count >= 1.2*B:
			count -= 1.2*B
			counter += 1600
			$buttons/military.set_text("Colonel")
			$militarylabel.set_text("4.5K/sec - Cost: 6.75B")
	if upgrade11 == 4:
		if count >= 6.75*B:
			count -= 6.75*B
			counter += 4500
...
func _on_politics_pressed():
	if upgrade12 == 0:
		if count >= 12.5*M:
			...
			counter += 50
			$buttons/politics.set_text("Candidate")
			$politicslabel.set_text("175/sec - Cost: 87.5M")
			$buttons/politics.set_disabled(true)
	if upgrade12 == 1:
		if count >= 87.5*M:
			count -= 87.5*M
			counter += 175
			$buttons/politics.set_text("Mayor")
			$politicslabel.set_text("475/sec - Cost: 475M")
			$buttons/politics.set_disabled(true)
	if upgrade12 == 2:
		if count >= 475*M:
			count -= 475*M
			counter += 475
			$buttons/politics.set_text("Minister")
			$politicslabel.set_text("4.5K/sec - Cost: 9B")
			$buttons/politics.set_disabled(true)
	if upgrade12 == 3:
		if count >= 9*B:
			count -= 9*B
			counter += 4500
			$buttons/politics.set_text("President")
			$politicslabel.set_text("8.5K/sec - Cost: 25B")
			$buttons/politics.set_disabled(true)
	if upgrade12 == 4:
		if count >= 25*B:
			count -= 25*B
